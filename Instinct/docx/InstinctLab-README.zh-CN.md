...
我们的目标是将面向人形机器人足式机器人全身控制的强化学习工程化、工业化。
...
- 按照官方安装指南安装 Isaac Lab，并且**切换到 5.1.0 版本**。建议使用 conda 方式安装，这样更方便从终端直接调用 Python 脚本。当前发布版本所使用的 IsaacLab 提交为 `37ddf626871758333d6ed89cf64ad702aef127d0`，日期为 2026 年 1 月 30 日。

- 按照 Instinct-RL 的安装指南安装 `instinct_rl`。
  简要步骤如下：
...
- 如果你要配合 `instinct-rl` 运行，在安装好 `instinct_rl` 后，可以执行：
...
为了保留你自己的代码开发历史和进展，强烈建议你参考 Isaac Lab 的 own-project 文档创建你自己的独立仓库。
